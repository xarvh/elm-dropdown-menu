...
var _user$project$DropdownMenu$reversePicker = function (picker) {
	return function (_p0) {
		return picker(
			A2(_elm_lang$core$Tuple$mapSecond, _elm_lang$core$List$reverse, _p0));
	};
};
var _user$project$DropdownMenu$maybeOpenState = F2(
	function (config, model) {
		var _p1 = config.modelToMaybeOpenState(model);
		if (_p1.ctor === 'Just') {
...
var _user$project$DropdownMenu$maybeSelectionId = F2(
	function (config, model) {
		return A2(
			_elm_lang$core$Maybe$map,
			config.itemToId,
			config.modelToMaybeSelection(model));
	});
var _user$project$DropdownMenu$pick = F3(
	function (config, model, picker) {
		var _p2 = A2(_user$project$DropdownMenu$maybeOpenState, config, model);
		if (_p2.ctor === 'Nothing') {
			return A2(_user$project$DropdownMenu$maybeSelectionId, config, model);
		} else {
			return picker(
				A2(
					F2(
					...
					A2(
						_elm_lang$core$List$map,
						config.itemToId,
						config.modelToItems(model))));
		}
	});
var _user$project$DropdownMenu$findNext = F2(
	function (e, items) {
		findNext:
		while (true) {
			var _p3 = items;
			if ((_p3.ctor === '::') && (_p3._1.ctor === '::')) {
				var _p4 = _p3._1._0;
				if (_elm_lang$core$Native_Utils.eq(_p3._0, e)) {
					return _elm_lang$core$Maybe$Just(_p4);
				} else {
					var _v3 = e,
						_v4 = {ctor: '::', _0: _p4, _1: _p3._1._1};
					e = _v3;
					items = _v4;
					continue findNext;
				}
...
var _user$project$DropdownMenu$findItem = F3(
	function (config, model, maybeId) {
		return A2(
...
var _user$project$DropdownMenu$maybeFallback = F2(
...
var _user$project$DropdownMenu$pickerNext = function (_p6) {
	var _p7 = _p6;
	var _p9 = _p7._1;
	var _p8 = _p7._0.maybeHighlightId;
	if (_p8.ctor === 'Nothing') {
		return _elm_lang$core$List$head(_p9);
	} else {
		return A2(
			_user$project$DropdownMenu$maybeFallback,
			_elm_lang$core$List$head(
				_elm_lang$core$List$reverse(_p9)),
			A2(_user$project$DropdownMenu$findNext, _p8._0, _p9));
	}
};
var _user$project$DropdownMenu$pickerSkip = F2(
	function (skip, _p10) {
		var _p11 = _p10;
		var _p13 = _p11._1;
		var _p12 = _p11._0.maybeHighlightId;
		if (_p12.ctor === 'Nothing') {
			return _elm_lang$core$List$head(_p13);
		} else {
			return A2(
				_user$project$DropdownMenu$maybeFallback,
				_elm_lang$core$List$head(
...
var _user$project$DropdownMenu$noCmd = function (outcome) {
	return {ctor: '_Tuple2', _0: outcome, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$DropdownMenu$itemToHtml = F4(
	function (itemToLabel, isSelected, isHighlighted, item) {
		return _elm_lang$html$Html$text(
			itemToLabel(item));
	});
var _user$project$DropdownMenu$namespace = function (s) {
	return A2(_elm_lang$core$Basics_ops['++'], 'ElmDropdownMenu-', s);
};
var _user$project$DropdownMenu$defaultClasses = {
	root: _user$project$DropdownMenu$namespace('root'),
	isOpen: _user$project$DropdownMenu$namespace('isOpen'),
	isClosed: _user$project$DropdownMenu$namespace('isClosed'),
	isDisabled: _user$project$DropdownMenu$namespace('isDisabled'),
	selectBox: _user$project$DropdownMenu$namespace('selectBox'),
	selection: _user$project$DropdownMenu$namespace('selection'),
	placeholder: _user$project$DropdownMenu$namespace('placeholder'),
	clearButton: _user$project$DropdownMenu$namespace('clearButton'),
	downArrow: _user$project$DropdownMenu$namespace('downArrow'),
	menu: _user$project$DropdownMenu$namespace('menu'),
	menuOption: _user$project$DropdownMenu$namespace('menuOption'),
	menuOptionSelected: _user$project$DropdownMenu$namespace('menuOptionSelected'),
	menuOptionHighlighted: _user$project$DropdownMenu$namespace('menuOptionHighlighted')
};
var _user$project$DropdownMenu$defaultCommonFeatures = {
	downArrow: _elm_lang$html$Html$text('▼'),
	clearButton: _elm_lang$html$Html$text('×'),
	scrollIntoView: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Cmd$none),
	classes: _user$project$DropdownMenu$defaultClasses
};
var _user$project$DropdownMenu$itemIdToDomId = function (itemId) {
	return _user$project$DropdownMenu$namespace(
		A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex('[^a-zA-Z0-9_-]'),
...
var _user$project$DropdownMenu$itemToDomId = F2(
	function (config, item) {
		return _user$project$DropdownMenu$itemIdToDomId(
			config.itemToId(item));
	});
var _user$project$DropdownMenu$scrollToHighlight = F2(
	function (commonFeatures, openState) {
		var _p15 = openState.maybeHighlightId;
		if (_p15.ctor === 'Nothing') {
			...
			return A2(
				...
				commonFeatures.scrollIntoView(
					_user$project$DropdownMenu$itemIdToDomId(_p15._0)));
		}
	});
var _user$project$DropdownMenu$openModel = {maybeHighlightId: _elm_lang$core$Maybe$Nothing, searchCounter: 0, searchString: ''};
var _user$project$DropdownMenu$CommonFeatures = F4(
	function (a, b, c, d) {
		return {downArrow: a, clearButton: b, scrollIntoView: c, classes: d};
	});
var _user$project$DropdownMenu$Classes = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {root: a, isOpen: b, isClosed: c, isDisabled: d, selectBox: e, selection: f, placeholder: g, clearButton: h, downArrow: i, menu: j, menuOption: k, menuOptionSelected: l, menuOptionHighlighted: m};
												};
											};
										};
									};
...
var _user$project$DropdownMenu$Config = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {hasClearButton: a, itemToHtml: b, itemToId: c, itemToLabel: d, modelToItems: e, modelToMaybeOpenState: f, modelToMaybeSelection: g, msgWrapper: h, placeholder: i};
	});
var _user$project$DropdownMenu$Setters = F3(
	function (a, b, c) {
		return {closeAllDropdowns: a, openOnlyThisDropdown: b, setCurrentSelection: c};
	});
var _user$project$DropdownMenu$PrivateOpenState = F3(
	function (a, b, c) {
		return {maybeHighlightId: a, searchCounter: b, searchString: c};
	});
var _user$project$DropdownMenu$OpenWithState = function (a) {
	return {ctor: 'OpenWithState', _0: a};
};
var _user$project$DropdownMenu$CloseAndSelect = function (a) {
	return {ctor: 'CloseAndSelect', _0: a};
};
var _user$project$DropdownMenu$updateNoChange = F3(
	function (commonFeatures, config, model) {
		var _p16 = config.modelToMaybeOpenState(model);
		if (_p16.ctor === 'Nothing') {
			return _user$project$DropdownMenu$noCmd(
				_user$project$DropdownMenu$CloseAndSelect(
					config.modelToMaybeSelection(model)));
		} else {
			return _user$project$DropdownMenu$noCmd(
				_user$project$DropdownMenu$OpenWithState(_p16._0));
		}
	});
var _user$project$DropdownMenu$updateClose = F3(
	function (commonFeatures, config, model) {
		return _user$project$DropdownMenu$noCmd(
			_user$project$DropdownMenu$CloseAndSelect(
				config.modelToMaybeSelection(model)));
	});
var _user$project$DropdownMenu$updateSelect = F4(
	function (maybeItemId, commonFeatures, config, model) {
		return _user$project$DropdownMenu$noCmd(
			_user$project$DropdownMenu$CloseAndSelect(
				A3(_user$project$DropdownMenu$findItem, config, model, maybeItemId)));
	});
var _user$project$DropdownMenu$OpenState = function (a) {
	return {ctor: 'OpenState', _0: a};
};
var _user$project$DropdownMenu$open = _user$project$DropdownMenu$OpenState(_user$project$DropdownMenu$openModel);
var _user$project$DropdownMenu$updateHighlight = F4(
	function (maybeHighlightId, commonFeatures, config, model) {
		var openState = _elm_lang$core$Native_Utils.update(
			_user$project$DropdownMenu$openModel,
			{maybeHighlightId: maybeHighlightId, searchString: ''});
		var cmd = A2(_user$project$DropdownMenu$scrollToHighlight, commonFeatures, openState);
		return {
			ctor: '_Tuple2',
			_0: _user$project$DropdownMenu$OpenWithState(
				_user$project$DropdownMenu$OpenState(openState)),
			_1: cmd
		};
	});
var _user$project$DropdownMenu$Searchable = function (a) {
	return {ctor: 'Searchable', _0: a};
};
var _user$project$DropdownMenu$End = {ctor: 'End'};
var _user$project$DropdownMenu$Home = {ctor: 'Home'};
var _user$project$DropdownMenu$PageDown = {ctor: 'PageDown'};
var _user$project$DropdownMenu$PageUp = {ctor: 'PageUp'};
var _user$project$DropdownMenu$ArrowDown = {ctor: 'ArrowDown'};
var _user$project$DropdownMenu$ArrowUp = {ctor: 'ArrowUp'};
var _user$project$DropdownMenu$Space = {ctor: 'Space'};
var _user$project$DropdownMenu$Enter = {ctor: 'Enter'};
var _user$project$DropdownMenu$Esc = {ctor: 'Esc'};
var _user$project$DropdownMenu$keyDecoder = F3(
	function (config, model, keyCode) {
		var key = _elm_lang$core$Json_Decode$succeed;
		var pass = _elm_lang$core$Json_Decode$fail('');
		var _p17 = keyCode;
		switch (_p17) {
			case 13:
				return key(_user$project$DropdownMenu$Enter);
			case 27:
				return _elm_lang$core$Native_Utils.eq(
					A2(_user$project$DropdownMenu$maybeOpenState, config, model),
					_elm_lang$core$Maybe$Nothing) ? pass : key(_user$project$DropdownMenu$Esc);
			case 32:
				return key(_user$project$DropdownMenu$Space);
			case 33:
				return key(_user$project$DropdownMenu$PageUp);
			case 34:
				return key(_user$project$DropdownMenu$PageDown);
			case 35:
				return key(_user$project$DropdownMenu$End);
			case 36:
				return key(_user$project$DropdownMenu$Home);
			case 38:
				return key(_user$project$DropdownMenu$ArrowUp);
			case 40:
				return key(_user$project$DropdownMenu$ArrowDown);
			default:
				...
				var $char = _elm_lang$core$Char$fromCode(keyCode);
				return (isAlpha($char) || (_elm_lang$core$Char$isDigit($char) || _elm_lang$core$Native_Utils.eq(
					$char,
					_elm_lang$core$Native_Utils.chr('\b')))) ? key(
					_user$project$DropdownMenu$Searchable($char)) : pass;
		}
	});
var _user$project$DropdownMenu$OnTransitionEnd = {ctor: 'OnTransitionEnd'};
var _user$project$DropdownMenu$OnResetSearchString = function (a) {
	return {ctor: 'OnResetSearchString', _0: a};
};
var _user$project$DropdownMenu$updateSearchStringTimeout = F4(
	function (searchChar, commonFeatures, config, model) {
		var oldOpenState = A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$DropdownMenu$openModel,
			A2(_user$project$DropdownMenu$maybeOpenState, config, model));
		var searchCounter = oldOpenState.searchCounter + 1;
		var cmdTimeout = A2(
			_elm_lang$core$Task$perform,
			function (_p18) {
				var _p19 = _p18;
				return _user$project$DropdownMenu$OnResetSearchString(searchCounter);
			},
			_elm_lang$core$Process$sleep(1.0 * _elm_lang$core$Time$second));
		var searchString = _elm_lang$core$Native_Utils.eq(
			searchChar,
			_elm_lang$core$Native_Utils.chr('\b')) ? A2(_elm_lang$core$String$dropRight, 1, oldOpenState.searchString) : A2(
			_elm_lang$core$Basics_ops['++'],
			oldOpenState.searchString,
			_elm_lang$core$String$toLower(
				_elm_lang$core$String$fromChar(searchChar)));
		var matchesSearchString = function (item) {
			return A2(
		...
		var maybeHighlightId = A2(
			_user$project$DropdownMenu$maybeFallback,
			oldOpenState.maybeHighlightId,
			A2(
				_elm_lang$core$Maybe$map,
				config.itemToId,
				A2(
		...
		var openState = _elm_lang$core$Native_Utils.update(
			oldOpenState,
			{maybeHighlightId: maybeHighlightId, searchCounter: searchCounter, searchString: searchString});
		var cmdHighlight = A2(_user$project$DropdownMenu$scrollToHighlight, commonFeatures, openState);
...
var _user$project$DropdownMenu$updatePartial = F3(
	function (config, model, msg) {
		var pickHighlight = function (_p20) {
			return _user$project$DropdownMenu$updateHighlight(
				A3(_user$project$DropdownMenu$pick, config, model, _p20));
		};
		var _p21 = msg;
		switch (_p21.ctor) {
			case 'NoOp':
				return _user$project$DropdownMenu$updateNoChange;
			case 'OnClickCurrentSelection':
				var _p22 = A2(_user$project$DropdownMenu$maybeOpenState, config, model);
				if (_p22.ctor === 'Nothing') {
					...
					return _user$project$DropdownMenu$updateClose;
				}
			case 'OnClickItem':
				return _user$project$DropdownMenu$updateSelect(
					_elm_lang$core$Maybe$Just(_p21._0));
			case 'OnMouseEnterItem':
				var _p23 = A2(_user$project$DropdownMenu$maybeOpenState, config, model);
				if (_p23.ctor === 'Nothing') {
					return _user$project$DropdownMenu$updateNoChange;
				} else {
					return _user$project$DropdownMenu$updateHighlight(
			...
			case 'OnClickClear':
				return _user$project$DropdownMenu$updateSelect(_elm_lang$core$Maybe$Nothing);
			case 'OnTransitionEnd':
				var _p24 = A2(_user$project$DropdownMenu$maybeOpenState, config, model);
				if (_p24.ctor === 'Nothing') {
					return _user$project$DropdownMenu$updateNoChange;
				} else {
					return _user$project$DropdownMenu$updateHighlight(_p24._0.maybeHighlightId);
				}
			case 'OnResetSearchString':
				var _p25 = A2(_user$project$DropdownMenu$maybeOpenState, config, model);
				if (_p25.ctor === 'Nothing') {
					return _user$project$DropdownMenu$updateNoChange;
				} else {
					var _p26 = _p25._0;
					return (!_elm_lang$core$Native_Utils.eq(_p26.searchCounter, _p21._0)) ? _user$project$DropdownMenu$updateNoChange : _user$project$DropdownMenu$updateHighlight(_p26.maybeHighlightId);
				}
			case 'OnBlur':
				return _user$project$DropdownMenu$updateClose;
			default:
				switch (_p21._0.ctor) {
					case 'Esc':
						return _user$project$DropdownMenu$updateClose;
					case 'Enter':
						var _p27 = A2(_user$project$DropdownMenu$maybeOpenState, config, model);
						if (_p27.ctor === 'Nothing') {
							return _user$project$DropdownMenu$updateHighlight(
								A2(_user$project$DropdownMenu$maybeSelectionId, config, model));
						} else {
							return _user$project$DropdownMenu$updateSelect(_p27._0.maybeHighlightId);
						}
					case 'Space':
						return _user$project$DropdownMenu$updateHighlight(
							A2(_user$project$DropdownMenu$maybeSelectionId, config, model));
					case 'ArrowUp':
						return pickHighlight(
							function (_p28) {
								return _user$project$DropdownMenu$pickerNext(
									A2(_elm_lang$core$Tuple$mapSecond, _elm_lang$core$List$reverse, _p28));
							});
					case 'ArrowDown':
						return pickHighlight(_user$project$DropdownMenu$pickerNext);
					case 'PageUp':
						return pickHighlight(
							function (_p29) {
								return A2(
									_user$project$DropdownMenu$pickerSkip,
									9,
									A2(_elm_lang$core$Tuple$mapSecond, _elm_lang$core$List$reverse, _p29));
							});
					case 'PageDown':
						return pickHighlight(
							_user$project$DropdownMenu$pickerSkip(9));
					case 'Home':
						return pickHighlight(
							function (_p30) {
								return _elm_lang$core$List$head(
					...
					default:
						return _user$project$DropdownMenu$updateSearchStringTimeout(_p21._0._0);
				}
		}
	});
var _user$project$DropdownMenu$update = F5(
	function (commonFeatures, config, setters, msg, model) {
		var partial = A3(_user$project$DropdownMenu$updatePartial, config, model, msg);
		var _p32 = A3(partial, commonFeatures, config, model);
		var outcome = _p32._0;
		var dropdownCmd = _p32._1;
		var _p33 = function () {
			var _p34 = outcome;
			if (_p34.ctor === 'OpenWithState') {
				return A2(setters.openOnlyThisDropdown, _p34._0, model);
			} else {
				var _p35 = _p34._0;
				var updateSelection = (!_elm_lang$core$Native_Utils.eq(
					_p35,
					config.modelToMaybeSelection(model))) ? setters.setCurrentSelection(_p35) : _user$project$DropdownMenu$noCmd;
				return updateSelection(
					setters.closeAllDropdowns(model));
			}
		}();
		var newParentModel = _p33._0;
		var userCmd = _p33._1;
		var cmd = _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, config.msgWrapper, dropdownCmd),
				_1: {
					ctor: '::',
					_0: userCmd,
					_1: {ctor: '[]'}
...
var _user$project$DropdownMenu$OnClickClear = {ctor: 'OnClickClear'};
var _user$project$DropdownMenu$OnMouseEnterItem = function (a) {
	return {ctor: 'OnMouseEnterItem', _0: a};
};
var _user$project$DropdownMenu$OnClickItem = function (a) {
	return {ctor: 'OnClickItem', _0: a};
};
var _user$project$DropdownMenu$OnClickCurrentSelection = {ctor: 'OnClickCurrentSelection'};
var _user$project$DropdownMenu$OnBlur = {ctor: 'OnBlur'};
var _user$project$DropdownMenu$OnKey = function (a) {
	return {ctor: 'OnKey', _0: a};
};
var _user$project$DropdownMenu$NoOp = {ctor: 'NoOp'};
var _user$project$DropdownMenu$htmlNeverToHtmlMsg = _elm_lang$html$Html$map(
	_elm_lang$core$Basics$always(_user$project$DropdownMenu$NoOp));
var _user$project$DropdownMenu$viewItem = F5(
	function (commonFeatures, config, model, maybeHighlightId, item) {
		var isHighlighted = function () {
			var _p36 = maybeHighlightId;
			if (_p36.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(
					config.itemToId(item),
					_p36._0);
		...
		var isSelected = function () {
			var _p37 = A2(_user$project$DropdownMenu$maybeSelectionId, config, model);
			if (_p37.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(
					config.itemToId(item),
					_p37._0);
		...
		var classes = _elm_lang$html$Html_Attributes$classList(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: commonFeatures.classes.menuOption, _1: true},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: commonFeatures.classes.menuOptionSelected, _1: isSelected},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: commonFeatures.classes.menuOptionHighlighted, _1: isHighlighted},
						_1: {ctor: '[]'}
					}
				}
			});
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$DropdownMenu$OnClickItem(
							config.itemToId(item))),
					_1: {
						ctor: '::',
						_0: A2(
							...
							'mousemove',
							_elm_lang$core$Json_Decode$succeed(
								_user$project$DropdownMenu$OnMouseEnterItem(
									config.itemToId(item)))),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id(
								A2(_user$project$DropdownMenu$itemToDomId, config, item)),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			{
				ctor: '::',
				_0: _user$project$DropdownMenu$htmlNeverToHtmlMsg(
					A3(config.itemToHtml, isSelected, isHighlighted, item)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$DropdownMenu$viewSelection = F3(
	function (commonFeatures, config, model) {
		var onClickNoBubble = function (_p38) {
			return A3(
				_elm_lang$html$Html_Events$onWithOptions,
				'click',
				{stopPropagation: true, preventDefault: false},
				_elm_lang$core$Json_Decode$succeed(_p38));
		};
		var maybeSelId = A2(_user$project$DropdownMenu$maybeSelectionId, config, model);
		var currentSelection = function () {
			var _p39 = A3(_user$project$DropdownMenu$findItem, config, model, maybeSelId);
			if (_p39.ctor === 'Nothing') {
				return A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.placeholder),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: config.placeholder,
						_1: {ctor: '[]'}
					});
			} else {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.selection),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A3(config.itemToHtml, false, false, _p39._0),
						_1: {ctor: '[]'}
					});
			}
		}();
		var clearIcon = (config.hasClearButton && (!_elm_lang$core$Native_Utils.eq(maybeSelId, _elm_lang$core$Maybe$Nothing))) ? A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: onClickNoBubble(_user$project$DropdownMenu$OnClickClear),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.clearButton),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _user$project$DropdownMenu$htmlNeverToHtmlMsg(commonFeatures.clearButton),
				_1: {ctor: '[]'}
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.selectBox),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$DropdownMenu$OnClickCurrentSelection),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _user$project$DropdownMenu$htmlNeverToHtmlMsg(currentSelection),
				_1: {
					ctor: '::',
					_0: clearIcon,
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.downArrow),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _user$project$DropdownMenu$htmlNeverToHtmlMsg(commonFeatures.downArrow),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$DropdownMenu$viewEnabled = F3(
	function (commonFeatures, config, model) {
		var keyMsgDecoder = A2(
			_elm_lang$core$Json_Decode$map,
			_user$project$DropdownMenu$OnKey,
			A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_user$project$DropdownMenu$keyDecoder, config, model),
				_elm_lang$html$Html_Events$keyCode));
		var classOpenOrClosed = _elm_lang$core$Native_Utils.eq(
			A2(_user$project$DropdownMenu$maybeOpenState, config, model),
			_elm_lang$core$Maybe$Nothing) ? commonFeatures.classes.isClosed : commonFeatures.classes.isOpen;
		var maybeHighlightId = A2(
			_elm_lang$core$Maybe$andThen,
			function (_) {
				return _.maybeHighlightId;
			},
			A2(_user$project$DropdownMenu$maybeOpenState, config, model));
		var menuItems = A2(
			_elm_lang$core$List$map,
			A4(_user$project$DropdownMenu$viewItem, commonFeatures, config, model, maybeHighlightId),
			config.modelToItems(model));
		return A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.root),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(classOpenOrClosed),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$tabindex(0),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onBlur(_user$project$DropdownMenu$OnBlur),
								_1: {
									ctor: '::',
									_0: A3(
										_elm_lang$html$Html_Events$onWithOptions,
				...
				{
					ctor: '::',
					_0: A3(_user$project$DropdownMenu$viewSelection, commonFeatures, config, model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.menu),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html_Events$on,
												'transitionend',
												_elm_lang$core$Json_Decode$succeed(_user$project$DropdownMenu$OnTransitionEnd)),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html_Events$on,
...
var _user$project$DropdownMenu$viewDisabled = F3(
	function (commonFeatures, config, model) {
		return A2(
			_elm_lang$html$Html$map,
			function (msg) {
				return config.msgWrapper(_user$project$DropdownMenu$NoOp);
			},
			A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.isClosed),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(commonFeatures.classes.isDisabled),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$DropdownMenu$view = F4(
	function (commonFeatures, config, isDisabled, model) {
		return isDisabled ? A3(_user$project$DropdownMenu$viewDisabled, commonFeatures, config, model) : A3(_user$project$DropdownMenu$viewEnabled, commonFeatures, config, model);
	});

var _user$project$DropdownMenuScroll$dropdownMenuScroll = _elm_lang$core$Native_Platform.outgoingPort(
	'dropdownMenuScroll',
	function (v) {
		return v;
	});
var _user$project$DropdownMenuScroll$scrollToDomId = _user$project$DropdownMenuScroll$dropdownMenuScroll;

var _user$project$UI_DropdownMenu$stylesheet = function () {
	var standardInputBorderOnHover = A3(
		_rtfeldman$elm_css$Css$border3,
		_rtfeldman$elm_css$Css$px(1),
		_rtfeldman$elm_css$Css$solid,
		_rtfeldman$elm_css$Css$hex('00cccf'));
	var standardInputBorder = A3(
		_rtfeldman$elm_css$Css$border3,
		_rtfeldman$elm_css$Css$px(1),
		_rtfeldman$elm_css$Css$solid,
		_rtfeldman$elm_css$Css$hex('e0e0e0'));
	var black = _rtfeldman$elm_css$Css$hex('202027');
	var grey = _rtfeldman$elm_css$Css$hex('b1b1b1');
	var lightGrey = _rtfeldman$elm_css$Css$hex('f3f3f4');
	var white = _rtfeldman$elm_css$Css$hex('fff');
	var selectionGrow = {
		ctor: '::',
			...
			return A2(
				...
				p1,
				{
					...
					_0: _rtfeldman$elm_css$Css$descendants(
						{
							ctor: '::',
							_0: A2(_rtfeldman$elm_css$Css$class, p2, rules),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
		});
	var duration = A2(_rtfeldman$elm_css$Css$property, 'transition-duration', '100ms');
	var ease = A2(_rtfeldman$elm_css$Css$property, 'transition-timing-function', 'ease');
	var css = _user$project$DropdownMenu$defaultCommonFeatures.classes;
		...
		_1: {
					...
					_1: {
						...
						_1: {
							...
							_0: _rtfeldman$elm_css$Css$backgroundColor(
								_rtfeldman$elm_css$Css$hex('f3f3f4')),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: A2(_rtfeldman$elm_css$Css$property, 'transform', 'translate(0, -50%) scale(1, 0) translate(0, 50%)'),
						_1: {
							ctor: '::',
							_0: A2(_rtfeldman$elm_css$Css$property, 'transition', 'transform'),
							_1: {
								ctor: '::',
								_0: duration,
								_1: {
				...
				_1: {
					...
					_0: A3(
						...
						{
							ctor: '::',
							_0: A2(_rtfeldman$elm_css$Css$property, 'transform', 'translate(0, -50%) scale(1, 1) translate(0, 50%)'),
							_1: {
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Css$property, 'transition-properties', 'transform'),
								_1: {
									ctor: '::',
									_0: duration,
									_1: {
								...
								_0: _rtfeldman$elm_css$Css$descendants(
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$fill(grey),
												_1: {
													ctor: '::',
													_0: A2(_rtfeldman$elm_css$Css$property, 'transition-properties', 'fill, transform'),
													_1: {
														ctor: '::',
														_0: duration,
														_1: {
									...
									_0: _rtfeldman$elm_css$Css$descendants(
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$fill(black),
													_1: {
														ctor: '::',
														_0: A2(_rtfeldman$elm_css$Css$property, 'transform', 'rotate(180deg)'),
														_1: {
															ctor: '::',
															_0: A2(_rtfeldman$elm_css$Css$property, 'transition-properties', 'fill, transform'),
															_1: {
							...
							_1: {
								...
								_1: {
									...
									_0: A3(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$auto),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(_rtfeldman$elm_css$Css$class, css.selection, selectionGrow),
										_1: {
											ctor: '::',
											_0: A2(
												_rtfeldman$elm_css$Css$class,
												...
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$color(grey),
													_1: selectionGrow
												}),
											_1: {
												ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_0: _rtfeldman$elm_css$Css$hover(
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$fill(white),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$backgroundColor(white),
															_1: {
																ctor: '::',
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: A4(
																				...
																				A4(_rtfeldman$elm_css$Css$rgba, 48, 48, 55, 0.1)),
																			_1: {
																				ctor: '::',
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_0: A2(
																	_rtfeldman$elm_css$Css$class,
																	css.menuOptionHighlighted,
																	{
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$backgroundColor(lightGrey),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
...
var _user$project$UI_DropdownMenu$itemToHtml = _user$project$DropdownMenu$itemToHtml;
var _user$project$UI_DropdownMenu$commonFeatures = _elm_lang$core$Native_Utils.update(
	_user$project$DropdownMenu$defaultCommonFeatures,
	{scrollIntoView: _user$project$DropdownMenuScroll$scrollToDomId});
var _user$project$UI_DropdownMenu$update = _user$project$DropdownMenu$update(_user$project$UI_DropdownMenu$commonFeatures);
var _user$project$UI_DropdownMenu$view = _user$project$DropdownMenu$view(_user$project$UI_DropdownMenu$commonFeatures);

var _user$project$Form$noCmd = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$Form$selectParameter = F3(
	function (parameterIndex, maybeParameterOption, model) {
		var _p0 = maybeParameterOption;
		if (_p0.ctor === 'Nothing') {
			return _user$project$Form$noCmd(model);
		} else {
			var selectedParameterOptions = A3(_elm_lang$core$Array$set, parameterIndex, _p0._0, model.selectedParameterOptions);
			return _user$project$Form$noCmd(
				_elm_lang$core$Native_Utils.update(
					model,
					{selectedParameterOptions: selectedParameterOptions}));
		}
	});
var _user$project$Form$defaultParameterOptions = function (template) {
	return A2(
...
var _user$project$Form$selectTemplate = F2(
	function (maybeTemplate, model) {
		var _p2 = maybeTemplate;
		if (_p2.ctor === 'Nothing') {
			return _user$project$Form$noCmd(model);
		} else {
			var _p3 = _p2._0;
			return _user$project$Form$noCmd(
				_elm_lang$core$Native_Utils.update(
					model,
					{
						selectedTemplate: _p3,
						selectedParameterOptions: _user$project$Form$defaultParameterOptions(_p3)
					}));
		}
	});
var _user$project$Form$modelToMaybeOpenState = F2(
	function (targetDropdownId, model) {
		var _p4 = model.focus;
		if (_p4.ctor === 'FocusDropdown') {
			return _elm_lang$core$Native_Utils.eq(_p4._0, targetDropdownId) ? _elm_lang$core$Maybe$Just(_p4._1) : _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Form$Template = F3(
	function (a, b, c) {
		return {id: a, name: b, parameters: c};
	});
var _user$project$Form$Parameter = F3(
	function (a, b, c) {
		return {id: a, label: b, options: c};
	});
var _user$project$Form$ParameterOption = F2(
	function (a, b) {
		return {id: a, label: b};
	});
var _user$project$Form$Model = F5(
	function (a, b, c, d, e) {
		return {availableTemplates: a, focus: b, selectedInteger: c, selectedTemplate: d, selectedParameterOptions: e};
	});
var _user$project$Form$DropdownParameter = function (a) {
	return {ctor: 'DropdownParameter', _0: a};
};
var _user$project$Form$DropdownTemplates = {ctor: 'DropdownTemplates'};
var _user$project$Form$FocusInteger = function (a) {
	return {ctor: 'FocusInteger', _0: a};
};
var _user$project$Form$FocusDropdown = F2(
	function (a, b) {
		return {ctor: 'FocusDropdown', _0: a, _1: b};
	});
var _user$project$Form$openDropdown = F3(
	function (dropdownId, openState, model) {
		return _user$project$Form$noCmd(
			_elm_lang$core$Native_Utils.update(
				model,
				{
					focus: A2(_user$project$Form$FocusDropdown, dropdownId, openState)
				}));
	});
var _user$project$Form$FocusNone = {ctor: 'FocusNone'};
var _user$project$Form$closeAllDropdowns = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{focus: _user$project$Form$FocusNone});
};
var _user$project$Form$init = function (availableTemplates) {
	var selectedTemplate = _mgold$elm_nonempty_list$List_Nonempty$head(availableTemplates);
	return {
		availableTemplates: availableTemplates,
		focus: _user$project$Form$FocusNone,
		selectedInteger: 1,
		selectedTemplate: selectedTemplate,
		selectedParameterOptions: _user$project$Form$defaultParameterOptions(selectedTemplate)
	};
};
var _user$project$Form$OnIntegerInput = F2(
	function (a, b) {
		return {ctor: 'OnIntegerInput', _0: a, _1: b};
	});
var _user$project$Form$OnDropdownParameter = F2(
	function (a, b) {
		return {ctor: 'OnDropdownParameter', _0: a, _1: b};
	});
var _user$project$Form$parameterDropdownConfig = function (parameterIndex) {
	var modelToItems = function (model) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(
				_elm_lang$core$Maybe$map,
				function (_p5) {
					return _mgold$elm_nonempty_list$List_Nonempty$toList(
						function (_) {
							return _.options;
						}(_p5));
				},
				A2(_elm_lang$core$Array$get, parameterIndex, model.selectedTemplate.parameters)));
	};
	return {
		hasClearButton: false,
		itemToHtml: _user$project$UI_DropdownMenu$itemToHtml(
			function (_) {
				return _.label;
			}),
		itemToId: function (_) {
		...
		itemToLabel: function (_) {
			return _.label;
		},
		modelToItems: modelToItems,
		modelToMaybeSelection: function (_p6) {
			return A2(
				_elm_lang$core$Array$get,
				parameterIndex,
				function (_) {
					return _.selectedParameterOptions;
				}(_p6));
		},
		modelToMaybeOpenState: _user$project$Form$modelToMaybeOpenState(
			_user$project$Form$DropdownParameter(parameterIndex)),
		msgWrapper: _user$project$Form$OnDropdownParameter(parameterIndex),
		placeholder: _elm_lang$html$Html$text('')
	};
};
var _user$project$Form$viewParameterDropdown = F3(
	function (model, parameterIndex, parameter) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(parameterIndex),
									A2(_elm_lang$core$Basics_ops['++'], ': ', parameter.label)))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$UI_DropdownMenu$view,
						_user$project$Form$parameterDropdownConfig(parameterIndex),
						false,
						model),
					_1: {ctor: '[]'}
				}
...
var _user$project$Form$OnDropdownTemplate = function (a) {
	return {ctor: 'OnDropdownTemplate', _0: a};
};
var _user$project$Form$templatesDropdownConfig = function () {
	var modelToItems = function (model) {
		return A2(
			_elm_lang$core$List$sortBy,
			function (_) {
			...
			_mgold$elm_nonempty_list$List_Nonempty$toList(model.availableTemplates));
	};
	return {
		hasClearButton: false,
		itemToHtml: _user$project$UI_DropdownMenu$itemToHtml(
		...
		modelToItems: modelToItems,
		modelToMaybeOpenState: _user$project$Form$modelToMaybeOpenState(_user$project$Form$DropdownTemplates),
		modelToMaybeSelection: function (_p7) {
			return _elm_lang$core$Maybe$Just(
				function (_) {
					return _.selectedTemplate;
				}(_p7));
		},
		msgWrapper: _user$project$Form$OnDropdownTemplate,
		placeholder: _elm_lang$html$Html$text('')
	};
}();
var _user$project$Form$update = F2(
	function (msg, model) {
		...
		switch (_p8.ctor) {
			case 'OnIntegerInput':
				return _user$project$Form$noCmd(model);
			case 'OnDropdownTemplate':
				return A4(
					_user$project$UI_DropdownMenu$update,
					_user$project$Form$templatesDropdownConfig,
					{
						closeAllDropdowns: _user$project$Form$closeAllDropdowns,
						openOnlyThisDropdown: _user$project$Form$openDropdown(_user$project$Form$DropdownTemplates),
						setCurrentSelection: _user$project$Form$selectTemplate
					},
					_p8._0,
					model);
			default:
				...
				return A4(
					_user$project$UI_DropdownMenu$update,
					_user$project$Form$parameterDropdownConfig(_p9),
					{
						closeAllDropdowns: _user$project$Form$closeAllDropdowns,
						openOnlyThisDropdown: _user$project$Form$openDropdown(
							_user$project$Form$DropdownParameter(_p9)),
						setCurrentSelection: _user$project$Form$selectParameter(_p9)
					},
					_p8._1,
					model);
		}
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Templates dropdown'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A3(_user$project$UI_DropdownMenu$view, _user$project$Form$templatesDropdownConfig, false, model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Parameters dropdowns'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								_elm_lang$core$Array$toList(
									A2(
										...
										_user$project$Form$viewParameterDropdown(model),
						...
						function (_) {
							...
							_rtfeldman$elm_css$Css$compile(
								_elm_lang$core$List$singleton(
									_rtfeldman$elm_css$Css$stylesheet(_user$project$UI_DropdownMenu$stylesheet))))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Form$view(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$toNonEmpty = function (list) {
	var _p0 = _mgold$elm_nonempty_list$List_Nonempty$fromList(list);
	if (_p0.ctor === 'Nothing') {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
...
var _user$project$Main$templates = _user$project$Main$toNonEmpty(
	{
		ctor: '::',
		_0: {
			id: 'pizza',
			name: 'Pizza',
			parameters: _elm_lang$core$Array$fromList(
				{
					ctor: '::',
					_0: {
						id: 'hasTomato',
						label: 'Tomato?',
						options: _user$project$Main$toNonEmpty(
							{
								ctor: '::',
								_0: {id: 'hasTomato-0', label: 'Yes'},
								_1: {
									ctor: '::',
									_0: {id: 'hasTomato-1', label: 'No. THAT\'S NO PIZZA.'},
									_1: {
										ctor: '::',
										_0: {id: 'hasTomato-2', label: 'Fresh'},
										_1: {ctor: '[]'}
									}
								}
							})
					...
					_1: {
						...
						_0: {
							...
							options: _user$project$Main$toNonEmpty(
								{
									ctor: '::',
									_0: {id: 'mozzarella-0', label: 'Yes'},
									_1: {
										ctor: '::',
										_0: {id: 'mozzarella-1', label: 'No'},
										_1: {
											ctor: '::',
											_0: {id: 'mozzarella-2', label: 'Bufala'},
											_1: {ctor: '[]'}
										}
									}
								})
				...
				parameters: _elm_lang$core$Array$fromList(
					{
						...
						_0: {
							...
							options: _user$project$Main$toNonEmpty(
								{
									ctor: '::',
									_0: {id: 'f-0', label: 'Orange'},
									_1: {
										ctor: '::',
										_0: {id: 'f-1', label: 'Pear'},
										_1: {
											ctor: '::',
											_0: {id: 'f-2', label: 'Peach'},
											_1: {ctor: '[]'}
										}
									}
								})
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _user$project$Form$init(_user$project$Main$templates),
